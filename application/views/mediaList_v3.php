        ...
        <div class="container-fluid library-app">
            ...
            <div class="row">
                <?php if(!empty($Recent)){ ?>
                    <div class="col-12 list disable-text-selection mb-5">
                        ...
                        <div class="row">
                            ...
                            ?>
                            <div class="col-xxl-4 col-xl-4 col-12" id="<?= 'recents-'.$rct->id; ?>">
                                <div class="card d-flex flex-row mb-4 media-thumb-container">
                                    <a class="d-flex align-self-center media-thumbnail-icon" href="#">
                                        ...
                                        <?php } else { ?>
                                            <img src="<?= base_url('api/assets/media/').$rct->filename; ?>" alt="uploaded image" class="list-media-thumbnail responsive border-0" />
                                        <?php } ?>
                                    </a>
                                    <div class="d-flex flex-grow-1 min-width-zero">
                                        <div class="card-body align-self-center d-flex flex-column justify-content-between min-width-zero align-items-lg-center">
                                            <a href="#" class="w-100">
                                                <p class="list-item-heading mb-1 truncate"><?= $rct->filename; ?></p>
                                            </a>
                                            <p class="mb-1 text-muted text-small w-100 truncate"><?= date('d.M.Y',strtotime($rct->uploaded_date)); ?></p>
                                        </div>
                                        <div class="pl-1 align-self-center">
                                            <a href="#!" id="dropdown-<?= $integerCount; ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php if(!empty($Earlier)){ ?>
                    <div class="col-12 list disable-text-selection mb-5" data-check-all="checkAll">
