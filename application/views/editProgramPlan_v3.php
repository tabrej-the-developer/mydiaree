                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('lessonPlanList/save'); ?>" enctype="multipart/form-data" method="post" autocomplete="off">
                                ...
                                <?php } ?>
                                <?php if ($progPlanId != "") { ?>
                                    <input type="hidden" name="progplanid" value="<?= $progPlanId; ?>">
                                <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group mb-1">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text" class="form-control" name="start_date" value="<?= isset($ProgramPlan)?date('d-m-Y',strtotime($ProgramPlan->startdate)):''; ?>" required>
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group mb-1">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text" class="form-control" name="end_date" value="<?= isset($ProgramPlan)?date('d-m-Y',strtotime($ProgramPlan->enddate)):''; ?>" required>
                                                    <span class="input-group-text input-group-append input-group-addon">
                                                        <i class="simple-icon-calendar"></i>
                                                    </span>
                                                </div>
