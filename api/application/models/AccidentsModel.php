...
{
    $ins_arr = [
        'centerid' => isset($data->centerid) ? $data->centerid : "",
        'roomid' => isset($data->roomid) ? $data->roomid : "",
        'person_name' => isset($data->person_name) ? $data->person_name : "",
        'person_role' => isset($data->person_role) ? $data->person_role : "",
        'date' => isset($data->date) ? $data->date : "",
        'time' => isset($data->time) ? $data->time : "",
        // 'person_sign' => $data->person_sign,
        'childid' => isset($data->childid) ? $data->childid : "",
        'child_name' => isset($data->child_name) ? $data->child_name : "",
        'child_dob' => isset($data->child_dob) ? $data->child_dob : "",
        'child_age' => isset($data->child_age) ? $data->child_age : "",
        'child_gender' => isset($data->gender) ? $data->gender : "",
        'incident_date' => isset($data->incident_date) ? $data->incident_date : "",
        'incident_time' => isset($data->incident_time) ? $data->incident_time : "",
        'incident_location' => isset($data->incident_location) ? $data->incident_location : "",
        'witness_name' => isset($data->witness_name) ? $data->witness_name : "",
        'witness_date' => isset($data->witness_date) ? $data->witness_date : "",
        // 'witness_sign' => $data->witness_sign,
        'gen_actyvt' => isset($data->gen_actyvt) ? $data->gen_actyvt : "",
        'cause' => isset($data->cause) ? $data->cause : "",
        'illness_symptoms' => isset($data->illness_symptoms) ? $data->illness_symptoms : "",
        'missing_unaccounted' => isset($data->missing_unaccounted) ? $data->missing_unaccounted : "",
        'taken_removed' => isset($data->taken_removed) ? $data->taken_removed : "",
        // 'injury_image' => $data->injury_image,
        'action_taken' => isset($data->action_taken) ? $data->action_taken : "",
        'emrg_serv_attend' => isset($data->emrg_serv_attend) ? "Yes" : "No",
        'med_attention' => isset($data->med_attention) ? "Yes" : "No",
        'med_attention_details' => isset($data->med_attention_details) ? $data->med_attention_details : "",
        'prevention_step_1' => isset($data->prevention_step_1) ? $data->prevention_step_1 : "",
        'prevention_step_2' => isset($data->prevention_step_2) ? $data->prevention_step_2 : "",
        'prevention_step_3' => isset($data->prevention_step_3) ? $data->prevention_step_3 : "",
        'parent1_name' => isset($data->parent1_name) ? $data->parent1_name : "",
        'contact1_method' => isset($data->contact1_method) ? $data->contact1_method : "",
        'contact1_date' => isset($data->contact1_date) ? $data->contact1_date : "",
        'contact1_time' => isset($data->contact1_time) ? $data->contact1_time : "",
        'contact1_made' => isset($data->contact1_made) ? $data->contact1_made : "",
        'contact1_msg' => isset($data->contact1_msg) ? $data->contact1_msg : "",
        'parent2_name' => isset($data->parent2_name) ? $data->parent2_name : "",
        'contact2_method' => isset($data->contact2_method) ? $data->contact2_method : "",
        'contact2_date' => isset($data->contact2_date) ? $data->contact2_date : "",
        'contact2_time' => isset($data->contact2_time) ? $data->contact2_time : "",
        'contact2_made' => isset($data->contact2_made) ? $data->contact2_made : "",
        'contact2_msg' => isset($data->contact2_msg) ? $data->contact2_msg : "",
        'responsible_person_name' => isset($data->responsible_person_name) ? $data->responsible_person_name : "",
        'responsible_person_sign' => isset($data->responsible_person_sign) ? $data->responsible_person_sign : "",
        'rp_internal_notif_date' => isset($data->rp_internal_notif_date) ? $data->rp_internal_notif_date : "",
        'rp_internal_notif_time' => isset($data->rp_internal_notif_time) ? $data->rp_internal_notif_time : "",
        'nominated_supervisor_name' => isset($data->nominated_supervisor_name) ? $data->nominated_supervisor_name : "",
        'nominated_supervisor_sign' => isset($data->nominated_supervisor_sign) ? $data->nominated_supervisor_sign : "",
        'nominated_supervisor_date' => isset($data->nsv_date) ? $data->nsv_date : "",
        'nominated_supervisor_time' => isset($data->nsv_time) ? $data->nsv_time : "",
        'ext_notif_other_agency' => isset($data->otheragency) ? $data->otheragency : "",
        'enor_date' => isset($data->enor_date) ? $data->enor_date : "",
        'enor_time' => isset($data->enor_time) ? $data->enor_time : "",
        'ext_notif_regulatory_auth' => isset($data->Regulatoryauthority) ? $data->Regulatoryauthority : "",
        'enra_date' => isset($data->enra_date) ? $data->enra_date : "",
        'enra_time' => isset($data->enra_time) ? $data->enra_time : "",
        // 'ack_parent_name' => $data->ack_parent_name,
        // 'ack_date' => $data->ack_date,
        // 'ack_time' => $data->ack_time,
        'add_notes' => isset($data->add_notes) ? $data->add_notes : "",
        'added_by' => isset($data->userid) ? $data->userid : "",
