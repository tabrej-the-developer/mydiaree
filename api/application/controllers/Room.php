            ...
            if ($user_id != null && $res != null && $res->userid == $user_id) {
                ...
                if($roomId != null){
                    ...
                    foreach ($roomChilds as $roomChild) {
                        ...
                        $occupancy['Mon'] = $occupancy['Mon'] + (isset($occup[0]) ? $occup[0] : 0);
        $occupancy['Tue'] = $occupancy['Tue'] + (isset($occup[1]) ? $occup[1] : 0);
        $occupancy['Wed'] = $occupancy['Wed'] + (isset($occup[2]) ? $occup[2] : 0);
        $occupancy['Thu'] = $occupancy['Thu'] + (isset($occup[3]) ? $occup[3] : 0);
        $occupancy['Fri'] = $occupancy['Fri'] + (isset($occup[4]) ? $occup[4] : 0);
